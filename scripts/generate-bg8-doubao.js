 ...
 * Generate bg-8 (gaming girl scene)
 */
...
const prompt = {
  ...
  prompt: "8-bit pixel art, pixels, pixel art style, 16-bit game style, retro pixel art, pixelated, blocky pixels, game sprite style, young adult woman with neat hair, wearing short casual home dress, sitting at gaming setup, playing video games with focused expression, colorful gaming equipment and screens, cozy room environment, full scene showing gaming setup, NOT realistic, NOT photorealistic, NOT smooth, healing pixel art, Soul app aesthetic",
};
...
async function generateImage() {
  console.log('🎨 Generating bg-8 (Gaming girl scene)...\n');
