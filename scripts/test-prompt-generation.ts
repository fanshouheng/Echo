 ...
 * Generate actual prompts to debug image generation issues
 */
...
console.log("测试 1: 默认场景（sceneIndex=0）");
console.log("=".repeat(80));
const prompt1 = buildDoubaoPrompt(samplePersonality, 0, "9:16", "female");
console.log("生成的提示词：\n");
console.log(prompt1);
console.log("\n提示词长度:", prompt1.length);
console.log("\n");

console.log("=".repeat(80));
console.log("测试 2: 第二个场景（sceneIndex=1）");
console.log("=".repeat(80));
const prompt2 = buildDoubaoPrompt(samplePersonality, 1, "9:16", "female");
console.log("生成的提示词：\n");
console.log(prompt2);
console.log("\n提示词长度:", prompt2.length);
console.log("\n");

console.log("=".repeat(80));
console.log("测试 3: 第三个场景（sceneIndex=2）");
console.log("=".repeat(80));
const prompt3 = buildDoubaoPrompt(samplePersonality, 2, "9:16", "female");
console.log("生成的提示词：\n");
console.log(prompt3);
console.log("\n提示词长度:", prompt3.length);
console.log("\n");

console.log("=".repeat(80));
console.log("测试 4: 横版场景（aspectRatio=16:9）");
console.log("=".repeat(80));
const prompt4 = buildDoubaoPrompt(samplePersonality, 0, "16:9", "female");
console.log("生成的提示词：\n");
console.log(prompt4);
console.log("\n提示词长度:", prompt4.length);
console.log("\n");
...
console.log("对比分析：");
console.log("=".repeat(80));
console.log("提示词1 vs 提示词2 是否相同:", prompt1 === prompt2);
console.log("提示词1 vs 提示词3 是否相同:", prompt1 === prompt3);
console.log("\n");

// Find differences
if (prompt1 !== prompt2) {
  console.log("提示词1和提示词2的差异：");
  const lines1 = prompt1.split("。");
  const lines2 = prompt2.split("。");
  lines1.forEach((line1, i) => {
    if (lines2[i] !== line1) {
      console.log(`\n第${i + 1}段不同：`);
      console.log(`  提示词1: ${line1}`);
      console.log(`  提示词2: ${lines2[i]}`);
    }
  });
}
